...
class GiftsControllerTest < ActionController::TestCase
  ...
  test "should create gift" do
    assert_difference('Gift.count') do
      post :create, gift: { section: @gift.section, sectionb: @gift.sectionb, sectionc: @gift.sectionc, sectiond: @gift.sectiond }
    end
  ...
  test "should update gift" do
    patch :update, id: @gift, gift: { section: @gift.section, sectionb: @gift.sectionb, sectionc: @gift.sectionc, sectiond: @gift.sectiond }
    assert_redirected_to gift_path(assigns(:gift))
  end
